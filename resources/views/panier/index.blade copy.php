                            ...
                            <tbody>
                                @foreach ($panier->items as $item)
                                    <tr>
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">
                                                        @if ($item->piece && $item->piece->vehicle)
                                                            {{ $item->piece->vehicle->marque ?? '' }}
                                                            {{ $item->piece->vehicle->modele ?? '' }} â€¢
                                        ...
                                        <td>{{ number_format(($item->quantite ?? 0) * ($item->piece->prix ?? 0), 2, ',', ' ') }}
                                            FCFA</td>
                                        <td>
                                            <form action="{{ route('panier.remove', $item) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
