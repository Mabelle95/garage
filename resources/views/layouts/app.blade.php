...
<body>
                ...
                <ul class="nav flex-column">
                    ...
                    @auth
                        ...
                        @if(!(auth()->user()->role->value === 'admin'))
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('demandes-epaves*') ? 'active' : '' }}"
                        ...
                        @if(auth()->user()->role->value === 'casse')
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('pieces*') ? 'active' : '' }}"
                                    href="{{ route('pieces.index') }}">
                                    <i class="fas fa-cog me-2"></i> Gestion des pièces
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('gestion/commandes*') ? 'active' : '' }}"
                                    href="{{ route('gestion.commandes.index') }}">
                                    <i class="fas fa-shopping-cart me-2"></i> Commandes clients
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('gestion/stocks*') ? 'active' : '' }}"
                                    href="{{ route('gestion.stocks') }}">
                                    <i class="fas fa-boxes me-2"></i> Gestion des stocks
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('gestion/epaves*') ? 'active' : '' }}"
                                    href="{{ route('gestion.epaves.index') }}">
                        ...
                        @if(auth()->user()->role->value === 'client')
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('panier*') ? 'active' : '' }}"
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
                <div class="container-fluid">
                    <span class="navbar-text">
                        ...
                        <span
                            class="badge bg-{{ auth()->user()->role->value === 'admin' ? 'danger' : (auth()->user()->role->value === 'casse' ? 'success' : 'primary') }} ms-2">
    ...
    @if(Route::is('commandes.confirme'))
